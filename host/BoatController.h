...
struct Telemetry {
    ...
    int radarAngle = 90; // זווית הסרוו בזמן המדידה
};
...
public:
    ...
    // מחזיר true ומעדכן את out אם התקבלה שורה תקינה של 5 מספרים.
    // שורות שאינן 5 מספרים (למשל הודעות "ERROR:") יושמו ב-errorLine אם סופק.
